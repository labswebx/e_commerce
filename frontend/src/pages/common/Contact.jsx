      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <section className="text-center">
          ...
          <p className="max-w-3xl mx-auto text-lg text-gray-600">
            Have questions or need support? Reach out to our team - we're here
            to help!
          </p>
        </section>
        ...
        <div className="grid gap-12 md:grid-cols-2">
          ...
          <section className="p-8 rounded-lg bg-gray-50">
            ...
            <form className="space-y-6">
              ...
              <Button label="Send Message" type="submit" fullWidth />
            </form>
          </section>
          ...
          <section className="space-y-8">
            ...
            <div className="p-6 bg-white border border-gray-200 rounded-lg">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-600">support@cyber.com</p>
            ...
            <div className="p-6 bg-white border border-gray-200 rounded-lg">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-600">+91 83077 47802</p>
                  <p className="mt-2 text-sm text-gray-500">
            ...
            <div className="p-6 bg-white border border-gray-200 rounded-lg">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="p-3 text-gray-700 bg-gray-100 rounded-full hover:bg-gray-200"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
        ...
        {/*  Google Map Embed */}
        <section className="mt-12 overflow-hidden rounded-lg shadow-lg">
          ...
          <div className="h-96">
            <iframe
              ...
              marginHeight="0"
              marginWidth="0"
              src="https://maps.google.com/maps?q=123%20Tech%20Street%2C%20Mumbai%2C%20India&t=&z=15&ie=UTF8&iwloc=&output=embed"
